...
////  TravioApp
////
////  Created by Ece Poyraz on 23.11.2023.
////
//
////
////
...
//            print("Switch is ON")
//            alertSettings(getTitle: "Camera Access Required", getmessage: "To enable camera access, please go to Settings and turn on Camera for this app.")
//        } else {
//            print("Switch is OFF")
...
//            self.alertSettings(getTitle: "Location Access Required", getmessage:  "To enable Location access, please go to Settings and turn on Camera for this app.")
//        }else {
//            //checkAndRequestPermissionsIfNeeded()
//           // locationPermission()
//            self.alertSettings(getTitle: "Location Access Required", getmessage:  "To enable Location access, please go to Settings and turn on Camera for this app.")
...
//        //locationPermission()
//        // refreshSettings()
//        // NotificationCenter.default.addObserver(self, selector: #selector(permissionCamera), name: .permissionCamera, object: nil)
//        //  NotificationCenter.default.addObserver(self, selector: #selector(permissionPhotoLibrary), name: .permissionPhotoLibrary, object: nil)
//        //  NotificationCenter.default.addObserver(self, selector: #selector(permissionLocation), name: .permissionLocation, object: nil)
//
//    }
//   //check
...
//            camera.toggleSwitch.isOn = true
//        } else {
//            camera.toggleSwitch.isOn = false
//        }
//
//        // Fotoğraf kütüphanesi izni kontrolü
//        if PHPhotoLibrary.authorizationStatus() == .authorized {
//            photoLibrary.toggleSwitch.isOn = true
//        } else {
//            photoLibrary.toggleSwitch.isOn = false
//        }
//
//        // Konum izni kontrolü
//        if CLLocationManager.authorizationStatus() == .authorizedWhenInUse || CLLocationManager.authorizationStatus() == .authorizedAlways {
//            location.toggleSwitch.isOn = true
//        } else {
//            location.toggleSwitch.isOn = false
//        }
//    }
//    enum SwitchType {
